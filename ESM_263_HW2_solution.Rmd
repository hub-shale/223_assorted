...
```{r map_scenarios}
tm_shape(filter(scenarios, GRIDCODE %in% c(4, 10))) +
  tm_fill(col = "GRIDCODE", alpha = .6) +
  tm_shape(ROI) +
  tm_borders()

# this was messing with displaying multiple scenarios, not looking great rn
```
...
# it isnt explicit here, but money units are now in millions.
```
